...
def process_services(services, enterprise):
    ...
    svc_candidate = ["data", "index", "query", "fts", "eventing", "analytics", "mobile"]
    for svc in svc_set:
    ...
    if not enterprise:
        ...
        ce_svc_70 = set(["data", "index", "query", "fts", "mobile"])
        if svc_set not in [ce_svc_30, ce_svc_40, ce_svc_45, ce_svc_70]:
